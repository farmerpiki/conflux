...
static auto test_files(SV prefix)->V<fs::path>{
V<fs::path>out;
...
static auto read_file(fs::path const&p)->S{
std::ifstream f{p,std::ios::binary};
return S{std::istreambuf_iterator<char>{f},{}};
}
TEST_CASE("JSONTestSuite: y_* must accept","[jsontestsuite][y]"){
...
TEST_CASE("JSONTestSuite: n_* must reject","[jsontestsuite][n]"){
...
TEST_CASE("JSONTestSuite: i_* implementation-defined (tracked)","[jsontestsuite][i][!mayfail]"){
