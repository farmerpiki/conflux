...
TEST_CASE("http.cq_overflow: non-UB shutdown under small-CQ flood","[.flaky]"){
Router router;
router.get("/ping",[](HttpRequest const&){
...
bool const valid_status=
result==RunStatus::stopped_normally||
