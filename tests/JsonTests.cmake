...
add_executable(conflux_json_patch_tests json_patch_test.cxx)
target_link_libraries(conflux_json_patch_tests PRIVATE conflux conflux_options Catch2::Catch2WithMain)
...
add_executable(conflux_json_reader_decode_tests json_reader_decode_test.cxx)
target_link_libraries(conflux_json_reader_decode_tests PRIVATE conflux conflux_options Catch2::Catch2WithMain)
...
add_executable(conflux_json_sax_tests json_sax_test.cxx)
target_link_libraries(conflux_json_sax_tests PRIVATE conflux conflux_options Catch2::Catch2WithMain)
add_executable(conflux_json_schema_tests json_schema_test.cxx)
target_link_libraries(conflux_json_schema_tests PRIVATE conflux conflux_options Catch2::Catch2WithMain)
add_executable(conflux_json_stream_tests json_stream_test.cxx)
target_link_libraries(conflux_json_stream_tests PRIVATE conflux conflux_options Catch2::Catch2WithMain)
add_executable(conflux_json_storage_tests json_storage_test.cxx)
target_link_libraries(conflux_json_storage_tests PRIVATE conflux conflux_options Catch2::Catch2WithMain)
