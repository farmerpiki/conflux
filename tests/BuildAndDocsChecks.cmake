if(CONFLUX_BUILD_TESTS)
    function(conflux_add_python_check test_name script_path labels)
        add_test(NAME ${test_name}
            COMMAND "${Python3_EXECUTABLE}" "${PROJECT_SOURCE_DIR}/${script_path}")
    ...
    add_test(NAME build/package-config
        COMMAND "${PROJECT_SOURCE_DIR}/scripts/check-package-config.sh"
                "${PROJECT_SOURCE_DIR}")
    ...
    add_test(NAME build/module-fragility-regression
        COMMAND "${PROJECT_SOURCE_DIR}/scripts/check-module-interface-regressions.sh"
                "${PROJECT_SOURCE_DIR}")
    ...
    add_test(NAME build/optimized-presets
        COMMAND "${PROJECT_SOURCE_DIR}/scripts/check-optimized-presets.sh"
                "${PROJECT_SOURCE_DIR}")
    ...
    add_test(NAME build/header-first-contact-smoke
        COMMAND "${PROJECT_SOURCE_DIR}/scripts/check-header-first-contact-smoke.sh"
                "${PROJECT_SOURCE_DIR}")
    ...
    if(CONFLUX_RUN_HEADER_COMPONENT_SMOKE)
        add_test(NAME build/header-component-smoke
            COMMAND "${PROJECT_SOURCE_DIR}/scripts/check-header-component-smoke.sh"
                    "${PROJECT_SOURCE_DIR}")
    ...
    add_test(NAME build/mixed-module-header-smoke
        COMMAND "${PROJECT_SOURCE_DIR}/scripts/check-package-smoke-mixed-module-header.sh")
    ...
    add_test(NAME build/public-module-import-smoke
        COMMAND "${PROJECT_SOURCE_DIR}/scripts/check-public-module-import-smoke.sh"
                "${PROJECT_SOURCE_DIR}")
