...
struct H:JsonDefaultHandler{
V<bool>vals;
expected<void,JsonError>on_bool(bool b){
vals.push_back(b);
return{};
}
}h;
...
struct H:JsonDefaultHandler{
S got;
expected<void,JsonError>on_string(SV sv){
got=sv;
return{};
}
}h;
...
struct H:JsonDefaultHandler{
int64_t val{};
expected<void,JsonError>on_i64(int64_t v){
val=v;
return{};
}
}h;
...
struct H:JsonDefaultHandler{
uint64_t val{};
expected<void,JsonError>on_u64(uint64_t v){
val=v;
return{};
}
}h;
...
struct H:JsonDefaultHandler{
double val{};
expected<void,JsonError>on_double(double v){
val=v;
return{};
}
}h;
...
struct H:JsonDefaultHandler{
S raw;
expected<void,JsonError>on_number_raw(SV sv){
raw=sv;
return{};
}
}h;
...
expected<void,JsonError>on_key(SV k){
keys.emplace_back(k);
return{};
}
expected<void,JsonError>on_string(SV v){
