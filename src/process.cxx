...
int out_fd,
int err_fd)noexcept
:pid_{pid},stdin_fd_{in_fd},stdout_fd_{out_fd},stderr_fd_{err_fd}{}
Process(
Process&&o)noexcept
:pid_{exchange(o.pid_,-1)},stdin_fd_{exchange(o.stdin_fd_,-1)},stdout_fd_{exchange(o.stdout_fd_,-1)},stderr_fd_{exchange(o.stderr_fd_,-1)}{}
Process&operator=(
Process&&o)noexcept{
if(this!=&o){
close_pipes();
...
if(!child_setup_fd(child_in,STDIN_FILENO,opts.dup3_flags)||!child_setup_fd(child_out,STDOUT_FILENO,opts.dup3_flags)||!child_setup_fd(child_err,STDERR_FILENO,opts.dup3_flags)){
int err=errno;
[[maybe_unused]]auto wr=::write(exec_err_pipe[1],reinterpret_cast<char const*>(&err),sizeof(int));
::_exit(kExecFailed);
}
