...
return h_.is_os_fd()?static_cast<int>(h_.id):-1;
}
[[nodiscard]]int direct_slot()const noexcept{
return h_.is_direct()?static_cast<int>(h_.id):-1;
}
[[nodiscard]]int release_fd()noexcept{
if(!h_.is_os_fd())return-1;
int const fd=static_cast<int>(h_.id);
h_=RingFd{};
return fd;
}
[[nodiscard]]int release_direct_slot()noexcept{
if(!h_.is_direct())return-1;
