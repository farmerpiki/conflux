...
:fd_{other.fd_},timeout_sec_{other.timeout_sec_},tls_active_{other.tls_active_},tls_ctx_{move(other.tls_ctx_)},tls_stream_{move(other.tls_stream_)},rx_buf_{move(other.rx_buf_)},ehlo_caps_{move(other.ehlo_caps_)},resolver_{other.resolver_}{
other.fd_=-1;
