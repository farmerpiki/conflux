...
assert(
(task_ctrls_.size()+posted_ctrls_.size()+op_ctrls_.size())<32&&"Scope::track exceeded n=32; partition across multiple Scope instances");
#endif
