...
:pool_{pool},local_slot_{local_slot},view_{view}{}
...
:pool_{exchange(o.pool_,nullptr)},local_slot_{o.local_slot_},view_{o.view_}{}
...
SZ slab_count,
SZ slab_bytes)
:table_{table},base_{base},slab_bytes_{slab_bytes}{
...
inline unsigned FixedBuffer::slot()const noexcept{return pool_->base_+local_slot_;}
...
:pool_{pool},slot_{slot},read_fd_{read_fd},write_fd_{write_fd},capacity_{capacity}{}
...
PipePair(
PipePair&&o)noexcept
:pool_{exchange(o.pool_,nullptr)},slot_{o.slot_},read_fd_{exchange(o.read_fd_,-1)},write_fd_{exchange(o.write_fd_,-1)},capacity_{o.capacity_}{}
...
UserDataFn encoder)
:ring_{ring},completions_{completions},encode_ud_{move(encoder)}{}
