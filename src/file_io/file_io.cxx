...
:pool_{pool},slot_{slot},view_{view}{}
...
:pool_{exchange(o.pool_,nullptr)},slot_{o.slot_},view_{o.view_}{}
...
io_uring*ring_;
SZ slab_bytes_;
V<UPD<byte[],void(*)(void*)>>slabs_{};// aligned_alloc'd
V<unsigned>free_{};
...
SZ slab_count,
SZ slab_bytes)
:ring_{ring},slab_bytes_{slab_bytes}{
