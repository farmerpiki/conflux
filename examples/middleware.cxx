...
"<html><body>" "<h1>conflux middleware example</h1>" "<ul>" "<li><a href='/public/ping'>/public/ping</a></li>" "<li><a href='/private/profile'>/private/profile</a> (basic auth: demo/demo)</li>" "<li><a href='/private/token'>/private/token</a> (bearer token: valid-token)</li>" "</ul>" "</body></html>");
});
