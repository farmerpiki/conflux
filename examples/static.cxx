...
"<html><head><link rel='stylesheet' href='/assets/app.css'></head>" "<body><h1>conflux static example</h1>" "<p>Try <a href='/api/info'>/api/info</a> or <a href='/assets/hello.txt'>/assets/hello.txt</a>.</p>" "</body></html>");
