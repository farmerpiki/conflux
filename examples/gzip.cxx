...
"<html><body>" "<h1>Gzip middleware example</h1>" "<p>This response is transparently gzip-compressed when the client " "sends <code>Accept-Encoding: gzip</code>.</p>" "<p>Try: <code>curl -H 'Accept-Encoding: gzip' http://localhost:9093/ | gunzip</code></p>" "</body></html>");
});
