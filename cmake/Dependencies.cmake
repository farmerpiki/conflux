...
function(conflux_pkg_provider_from_registry token required)
    if(NOT token IN_LIST CONFLUX_EXTERNAL_DEPENDENCY_TOKENS)
        message(FATAL_ERROR "conflux_pkg_provider_from_registry(${token}): unknown external dependency token")
    endif()
...
if(CONFLUX_NEEDS_RUNTIME)
    ...
    conflux_pkg_provider_from_registry(LIBURING TRUE)
else()
...
if(CONFLUX_WANT_JSON AND NOT CONFLUX_JSON_HASH_PROVIDER_UPPER STREQUAL "INTERNAL")
    if(CONFLUX_JSON_HASH_PROVIDER_UPPER STREQUAL "XXHASH")
        conflux_pkg_provider_from_registry(XXHASH TRUE)
    else()
        conflux_pkg_provider_from_registry(XXHASH FALSE)
        if(XXHASH_FOUND)
...
if(CONFLUX_WANT_HTTP_COMPRESSION AND NOT CONFLUX_GZIP_PROVIDER_UPPER STREQUAL "OFF")
    conflux_pkg_provider_from_registry(LIBDEFLATE FALSE)
    conflux_pkg_provider_from_registry(ZLIB_NG FALSE)
    conflux_pkg_provider_from_registry(LIBISAL FALSE)
endif()
if(CONFLUX_WANT_HTTP_COMPRESSION AND NOT CONFLUX_BROTLI_PROVIDER_UPPER STREQUAL "OFF")
    conflux_pkg_provider_from_registry(BROTLI FALSE)
endif()
if(CONFLUX_WANT_HTTP_COMPRESSION AND NOT CONFLUX_ZSTD_PROVIDER_UPPER STREQUAL "OFF")
    conflux_pkg_provider_from_registry(ZSTD FALSE)
endif()
...
if((CONFLUX_WANT_HTTP_SERVER OR CONFLUX_WANT_HTTP_CLIENT)
    ...
    conflux_pkg_provider_from_registry(NGHTTP2 FALSE)
endif()
...
if(CONFLUX_WANT_HTTP_SERVER
    ...
    conflux_pkg_provider_from_registry(NGTCP2 FALSE)
    conflux_pkg_provider_from_registry(NGTCP2_CRYPTO_OSSL FALSE)
    conflux_pkg_provider_from_registry(NGHTTP3 FALSE)
endif()
...
if(CONFLUX_WANT_HTTP_AUTH
    ...
    conflux_pkg_provider_from_registry(ARGON2 FALSE)
endif()
...
if(CONFLUX_WANT_DB_POSTGRES AND NOT CONFLUX_POSTGRES_PROVIDER_UPPER STREQUAL "OFF")
    conflux_pkg_provider_from_registry(LIBPQ FALSE)
    if(LIBPQ_FOUND)
