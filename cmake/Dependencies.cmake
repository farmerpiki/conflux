...
if(CONFLUX_NEEDS_RUNTIME AND CONFLUX_USE_MOCK_LIBURING
        AND EXISTS "${CONFLUX_MOCK_LIBURING_ROOT}/include/liburing.h")
    if(NOT TARGET PkgConfig::LIBURING)
        ...
        set_target_properties(PkgConfig::LIBURING PROPERTIES
            INTERFACE_INCLUDE_DIRECTORIES "${CONFLUX_MOCK_LIBURING_ROOT}/include"
            INTERFACE_COMPILE_DEFINITIONS CONFLUX_MOCK_LIBURING=1)
    endif()
    set(LIBURING_FOUND TRUE)
    set(LIBURING_VERSION "mock")
    message(STATUS "conflux: using compile-only mock liburing provider")
elseif(CONFLUX_NEEDS_RUNTIME)
