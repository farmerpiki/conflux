...
set(CONFLUX_HTTP_STATIC_TARGET_REQUESTED FALSE)
if(CONFLUX_WANT_HTTP_STATIC OR CONFLUX_HTTP_ROUTER_STACK_REQUESTED)
    set(CONFLUX_HTTP_STATIC_TARGET_REQUESTED TRUE)
endif()

set(CONFLUX_HTTP_STATIC_SURFACE_REQUESTED FALSE)
if(CONFLUX_WANT_HTTP_STATIC)
    set(CONFLUX_HTTP_STATIC_SURFACE_REQUESTED TRUE)
endif()

set(CONFLUX_HTTP_REALTIME_TARGET_REQUESTED FALSE)
if(CONFLUX_WANT_HTTP_REALTIME OR CONFLUX_HTTP_ROUTER_STACK_REQUESTED)
    set(CONFLUX_HTTP_REALTIME_TARGET_REQUESTED TRUE)
endif()

set(CONFLUX_HTTP_REALTIME_SURFACE_REQUESTED FALSE)
if(CONFLUX_WANT_HTTP_REALTIME)
    set(CONFLUX_HTTP_REALTIME_SURFACE_REQUESTED TRUE)
endif()

conflux_require_component_flag(CONFLUX_HTTP_STATIC_TARGET_REQUESTED CONFLUX_WANT_RUNTIME
    "conflux: CONFLUX_BUILD_HTTP_STATIC requires CONFLUX_BUILD_RUNTIME")

conflux_require_component_flag(CONFLUX_HTTP_REALTIME_TARGET_REQUESTED CONFLUX_WANT_HTTP_CORE
    "conflux: CONFLUX_BUILD_HTTP_REALTIME/HTTP router components require CONFLUX_BUILD_HTTP_CORE")
conflux_require_component_flag(CONFLUX_HTTP_REALTIME_TARGET_REQUESTED CONFLUX_WANT_CRYPTO
