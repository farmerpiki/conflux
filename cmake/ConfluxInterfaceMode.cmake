    ...
    if(CONFLUX_USE_MOCK_LIBURING)
        ...
        if(PkgConfig_FOUND)
            ...
            if(TARGET PkgConfig::LIBURING)
                target_link_libraries(conflux_headers INTERFACE PkgConfig::LIBURING)
            endif()
        endif()
    endif()
...
function(conflux_add_header_examples_from_source_ids)
    ...
    if(CONFLUX_HAS_DB)
        ...
        conflux_note_header_example(conflux_quickstart_postgres skipped "requires CONFLUX_ENABLE_DB=ON and libpq")
        conflux_note_header_example(conflux_db_basic skipped "requires CONFLUX_ENABLE_DB=ON and libpq")
        conflux_note_header_example(conflux_db_pool skipped "requires CONFLUX_ENABLE_DB=ON and libpq")
        conflux_note_header_example(conflux_advanced_postgres skipped "requires CONFLUX_ENABLE_DB=ON and libpq")
    endif()
