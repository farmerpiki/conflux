...
- [ ] Split optional components: DB and remaining static implementation internals. TLS, HTTP/2, HTTP/3, static option types, SSE realtime types, and WebSocket realtime types now have separate link targets.
