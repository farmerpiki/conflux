...
struct FuzzHandler {
	...
	expected<void, JsonError> on_begin_object() { ++depth; return {}; }
	expected<void, JsonError> on_end_object() { --depth; return {}; }
	expected<void, JsonError> on_begin_array() { ++depth; return {}; }
	expected<void, JsonError> on_end_array() { --depth; return {}; }
