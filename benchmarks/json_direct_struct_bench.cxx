...
int main(
	...
	bench_info_if_requested(
		argc,
		argv,
		R"({"name":"json_direct_struct","parser":"standard","configs":[{"name":"field_order","extra":{"kind":"micro/user-space","case":"direct-to-struct member order and unknown-member policy","claim_scope":"diagnostic","interpretation":"Focused direct-to-struct decode gate (no I/O, DOM traversal, or routing); isolates reader-path cost, not a product-level JSON claim."},"target_ms":500,"max_iterations":5000,"calibration_iterations":4,"args":["--filter","order/","--filter","unknown/","--filter","boundary/","--config-name","field_order","--iterations","0","--warmup","0"]},{"name":"duplicates","extra":{"kind":"micro/user-space","case":"direct-to-struct duplicate-key modes","claim_scope":"diagnostic","interpretation":"Focused direct-to-struct decode gate (no I/O, DOM traversal, or routing); isolates reader-path cost, not a product-level JSON claim."},"target_ms":500,"max_iterations":5000,"calibration_iterations":4,"args":["--filter","duplicate/","--config-name","duplicates","--iterations","0","--warmup","0"]},{"name":"numeric","extra":{"kind":"micro/user-space","case":"direct-to-struct number lexing and fixed numeric arrays","claim_scope":"diagnostic","interpretation":"Focused direct-to-struct decode gate (no I/O, DOM traversal, or routing); isolates reader-path cost, not a product-level JSON claim."},"target_ms":500,"max_iterations":5000,"calibration_iterations":4,"args":["--filter","numeric/","--config-name","numeric","--iterations","0","--warmup","0"]},{"name":"strings","extra":{"kind":"micro/user-space","case":"direct-to-struct string decode","claim_scope":"diagnostic","interpretation":"Focused direct-to-struct decode gate (no I/O, DOM traversal, or routing); isolates reader-path cost, not a product-level JSON claim."},"target_ms":500,"max_iterations":5000,"calibration_iterations":4,"args":["--filter","strings/","--config-name","strings","--iterations","0","--warmup","0"]}],"filters":["--filter SUBSTR"]})");
