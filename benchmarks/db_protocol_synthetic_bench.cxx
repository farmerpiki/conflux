...
int main(
	...
	bench_info_if_requested(
		argc,
		argv,
		R"({"name":"db_protocol_synthetic","parser":"standard","configs":[{"name":"rows_16_payload_24","extra":{"rows":16,"payload_bytes":24},"target_ms":500,"max_iterations":200000,"calibration_iterations":8,"args":["--rows","16","--payload-bytes","24","--config-name","rows_16_payload_24","--iterations","5000","--warmup","200"]},{"name":"rows_128_payload_24","extra":{"rows":128,"payload_bytes":24},"target_ms":500,"max_iterations":100000,"calibration_iterations":8,"args":["--rows","128","--payload-bytes","24","--config-name","rows_128_payload_24","--iterations","2000","--warmup","100"]},{"name":"rows_128_payload_256","extra":{"rows":128,"payload_bytes":256},"target_ms":500,"max_iterations":50000,"calibration_iterations":4,"args":["--rows","128","--payload-bytes","256","--config-name","rows_128_payload_256","--iterations","1000","--warmup","50"]}]})");
