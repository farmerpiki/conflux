...
int main(
	...
	bench_info_if_requested(
		argc,
		argv,
		R"({"name":"http_app_path","parser":"standard","configs":[{"name":"get_ping","extra":{"kind":"micro/user-space","case":"GET /api/ping","claim_scope":"diagnostic","interpretation":"User-space HTTP app-path cost floor (parse/build request view, dispatch, format response, no socket/io_uring); an internal cost model, not server performance — do not compare to web frameworks."},"target_ms":500,"max_iterations":10000000,"calibration_iterations":16,"args":["--case","get_ping","--config-name","get_ping","--iterations","0","--warmup","0"]},{"name":"get_param","extra":{"kind":"micro/user-space","case":"GET /hello/{name}","claim_scope":"diagnostic","interpretation":"User-space HTTP app-path cost floor (parse/build request view, dispatch, format response, no socket/io_uring); an internal cost model, not server performance — do not compare to web frameworks."},"target_ms":500,"max_iterations":10000000,"calibration_iterations":16,"args":["--case","get_param","--config-name","get_param","--iterations","0","--warmup","0"]},{"name":"not_found","extra":{"kind":"micro/user-space","case":"404","claim_scope":"diagnostic","interpretation":"User-space HTTP app-path cost floor (parse/build request view, dispatch, format response, no socket/io_uring); an internal cost model, not server performance — do not compare to web frameworks."},"target_ms":500,"max_iterations":10000000,"calibration_iterations":16,"args":["--case","not_found","--config-name","not_found","--iterations","0","--warmup","0"]},{"name":"middleware_x1","extra":{"kind":"micro/user-space","middleware_count":1,"claim_scope":"diagnostic","interpretation":"User-space HTTP app-path cost floor (parse/build request view, dispatch, format response, no socket/io_uring); an internal cost model, not server performance — do not compare to web frameworks."},"target_ms":500,"max_iterations":10000000,"calibration_iterations":16,"args":["--case","middleware_x1","--config-name","middleware_x1","--iterations","0","--warmup","0"]},{"name":"middleware_x4","extra":{"kind":"micro/user-space","middleware_count":4,"claim_scope":"diagnostic","interpretation":"User-space HTTP app-path cost floor (parse/build request view, dispatch, format response, no socket/io_uring); an internal cost model, not server performance — do not compare to web frameworks."},"target_ms":500,"max_iterations":10000000,"calibration_iterations":16,"args":["--case","middleware_x4","--config-name","middleware_x4","--iterations","0","--warmup","0"]},{"name":"middleware_x16","extra":{"kind":"micro/user-space","middleware_count":16,"claim_scope":"diagnostic","interpretation":"User-space HTTP app-path cost floor (parse/build request view, dispatch, format response, no socket/io_uring); an internal cost model, not server performance — do not compare to web frameworks."},"target_ms":500,"max_iterations":10000000,"calibration_iterations":16,"args":["--case","middleware_x16","--config-name","middleware_x16","--iterations","0","--warmup","0"]},{"name":"json_small","extra":{"kind":"micro/user-space","case":"JSON response small","claim_scope":"diagnostic","interpretation":"User-space HTTP app-path cost floor (parse/build request view, dispatch, format response, no socket/io_uring); an internal cost model, not server performance — do not compare to web frameworks."},"target_ms":500,"max_iterations":10000000,"calibration_iterations":16,"args":["--case","json_small","--config-name","json_small","--iterations","0","--warmup","0"]},{"name":"json_medium","extra":{"kind":"micro/user-space","case":"JSON response medium","claim_scope":"diagnostic","interpretation":"User-space HTTP app-path cost floor (parse/build request view, dispatch, format response, no socket/io_uring); an internal cost model, not server performance — do not compare to web frameworks."},"target_ms":500,"max_iterations":10000000,"calibration_iterations":16,"args":["--case","json_medium","--config-name","json_medium","--iterations","0","--warmup","0"]},{"name":"post_body_parse_only","extra":{"kind":"micro/user-space","case":"POST body parse only","claim_scope":"diagnostic","interpretation":"User-space HTTP app-path cost floor (parse/build request view, dispatch, format response, no socket/io_uring); an internal cost model, not server performance — do not compare to web frameworks."},"target_ms":500,"max_iterations":10000000,"calibration_iterations":16,"args":["--case","post_body_parse_only","--config-name","post_body_parse_only","--iterations","0","--warmup","0"]},{"name":"post_echo","extra":{"kind":"micro/user-space","case":"POST echo 4KiB","claim_scope":"diagnostic","interpretation":"User-space HTTP app-path cost floor (parse/build request view, dispatch, format response, no socket/io_uring); an internal cost model, not server performance — do not compare to web frameworks."},"target_ms":500,"max_iterations":10000000,"calibration_iterations":16,"args":["--case","post_echo","--config-name","post_echo","--iterations","0","--warmup","0"]},{"name":"app_json_body","extra":{"kind":"micro/user-space","case":"App Json<T> request body","claim_scope":"diagnostic","interpretation":"User-space HTTP app-path cost floor (parse/build request view, dispatch, format response, no socket/io_uring); an internal cost model, not server performance — do not compare to web frameworks."},"target_ms":500,"max_iterations":10000000,"calibration_iterations":16,"args":["--case","app_json_body","--config-name","app_json_body","--iterations","0","--warmup","0"]},{"name":"app_query_params","extra":{"kind":"micro/user-space","case":"App QueryParams<T> aggregate fields","claim_scope":"diagnostic","interpretation":"User-space HTTP app-path cost floor (parse/build request view, dispatch, format response, no socket/io_uring); an internal cost model, not server performance — do not compare to web frameworks."},"target_ms":500,"max_iterations":10000000,"calibration_iterations":16,"args":["--case","app_query_params","--config-name","app_query_params","--iterations","0","--warmup","0"]},{"name":"app_form_params","extra":{"kind":"micro/user-space","case":"App FormParams<T> aggregate fields","claim_scope":"diagnostic","interpretation":"User-space HTTP app-path cost floor (parse/build request view, dispatch, format response, no socket/io_uring); an internal cost model, not server performance — do not compare to web frameworks."},"target_ms":500,"max_iterations":10000000,"calibration_iterations":16,"args":["--case","app_form_params","--config-name","app_form_params","--iterations","0","--warmup","0"]},{"name":"multipart_mixed","extra":{"kind":"micro/user-space","case":"multipart/form-data text and file parts","claim_scope":"diagnostic","interpretation":"User-space HTTP app-path cost floor (parse/build request view, dispatch, format response, no socket/io_uring); an internal cost model, not server performance — do not compare to web frameworks."},"target_ms":500,"max_iterations":10000000,"calibration_iterations":16,"args":["--case","multipart_mixed","--config-name","multipart_mixed","--iterations","0","--warmup","0"]}]})");
